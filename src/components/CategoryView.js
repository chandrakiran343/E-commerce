          ...
          <div className='categorybook-container'>
              ...
              {objects.map(i=>{return(
                  <div className='book-style'>
                      <button style={{color:'rgb(59, 151, 252)',marginBottom:'5px',height:'20%'}} onClick={() =>{return(console.log(i))}}><span style={{width:'100%',fontSize:'1em',textAlign:'center',fontWeight:'bolder'}}>{i.Name}</span></button>
                      <div className='content-holder'>
                          <span className='span-the-image'><img className='book-cover-style' src={i.CoverURL} alt='lol' /></span>
